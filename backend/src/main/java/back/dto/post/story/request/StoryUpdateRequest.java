...
public record StoryUpdateRequest(
        ...
        @Size(max = 999, message = "태그 멤버는 최대 999명까지 가능합니다.") List<@NotNull(message = "taggedMemberIds에는 null이 올 수 없습니다.") @Positive(message = "taggedMemberIds는 양수여야 합니다.") Long> taggedMemberIds) {
