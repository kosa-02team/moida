...
-- Stored Procedure를 사용하여 에러 발생 시에도 FK 체크 복구 보장
DELIMITER $$

DROP PROCEDURE IF EXISTS update_club_member_schema_v11$$

CREATE PROCEDURE update_club_member_schema_v11()
BEGIN
...
-- Stored Procedure 실행
CALL update_club_member_schema_v11();
